                        ...
                        >
                            ...
                            <MapContainer
                                ...
                                >
                                    ...
                                    <Slider label="min" value='min' updateOption={updateOption} defaultValue={options['min']} onChange={() => console.log()} tooltip='Adjust Min Value' min={0} max={100} delta={15} maxValue={65535} />
                                    <Slider label="max" value='max' updateOption={updateOption} defaultValue={options['max']} onChange={() => console.log()} tooltip='Adjust Max Value' min={0} max={100} delta={15} maxValue={65535} />
                                    <Slider icon='tint' value='blend' updateOption={updateOption} defaultValue={options['blend']} onChange={() => console.log()} tooltip='Adjust Opacity' min={0} max={100} delta={15} maxValue={100} />
                                    <Slider icon='tint' value='opacityThreshold' updateOption={updateOption} defaultValue={options['opacityThreshold']} onChange={() => console.log()} tooltip='Adjust Opacity Threshold (lowest % of pixel values will be transparent)' min={0} max={255} delta={10} maxValue={65535} />
                                    <Slider icon='sun' value='brightness' updateOption={updateOption} defaultValue={options['brightness']} onChange={() => console.log()} tooltip='Adjust Brightness' min={-100} max={100} delta={10} maxValue={65535} minValue={-65535} />
                                    <Slider icon='adjust' value='contrast' updateOption={updateOption} defaultValue={options['contrast']} onChange={() => console.log()} tooltip='Adjust Contrast' min={-100} max={100} delta={10} maxValue={65535} minValue={-65535} />
                                    <br></br>
                                        ...
                                        >
                                            ...
                                            >
                                                <OverlayTrigger
                                                    overlay={
                                                        <BSTooltip>
                                                            Show/hide Layers in the map or apply a Look Up Table to the layers
                                                        ...
                                                        Object.keys(slices).sort().reverse().map((wavelength, index) => {
                                                            return (
                                                                ...
                                                                >
                                                                    ...
                                                                    <LUTSelector layer={wavelength} changeLut={changeLut} option={lut[wavelength]} />
                                                                </div>)
                                                        }) : ""
                                                }
